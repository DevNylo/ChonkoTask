...
const PremiumInput = ({ label, icon, borderColor = '#E2E8F0', iconColor = '#F59E0B', ...props }) => (
...
export default function CreateFamilyScreen() {
  ...
  return (
    <ImageBackground
      source={require('../../../assets/Onboarding/CreateFamilyBKG.png')} // <-- AJUSTE O NOME AQUI SE NECESSÁRIO
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.cardWrapper}>
                {/* SOMBRA SALTADA (Soft Premium - Laranja) */}
                ...
                <View style={styles.cardFront}>
                    ...
                    <View style={styles.footerNavigation}>
                        ...
                        <TouchableOpacity style={styles.nextButton} activeOpacity={0.8} onPress={handleNextStep}>
                            {/* SOMBRA SOLIDIA (3D Dinâmico Laranja Escuro) */}
                            <View style={styles.btnShadow} />
                            {/* FRENTE SÓLIDA (3D Dinâmico Laranja) */}
...
const styles = StyleSheet.create({
  ...
  cardShadow: {
      ...
      width: '100%',
      height: '100%',
      backgroundColor: 'rgba(217, 119, 6, 0.15)', // Sombra Sólida Translúcida do Laranja Primário
  ...
  dropdownButton: {
    ...
    borderWidth: 1, borderColor: '#E2E8F0' // Borda Fina
  },
  ...
  // Security
  securityBox: { marginTop: 10, backgroundColor: '#FFFBEB', padding: 20, borderRadius: 24, borderWidth: 1, borderColor: '#FCD34D' }, // Borda Fina
  ...
  backButton: {
      ...
      borderWidth: 1, borderColor: '#FDE68A' // Borda Fina
  },

  // Botão Next (Bubbly Dinâmico 3D)
  ...
  modalContent: {
      ...
      borderTopWidth: 1, borderLeftWidth: 1, borderRightWidth: 1, borderColor: '#FDE68A', // Borda Fina
      paddingBottom: Platform.OS === 'ios' ? 40 : 30
  },
  modalIconTop: {
      width: 70, height: 70, backgroundColor: '#FEF3C7', borderRadius: 35,
      justifyContent: 'center', alignItems: 'center', marginBottom: 15,
      borderWidth: 1, borderColor: '#FCD34D', marginTop: -65 // Borda Fina
  },
  modalTitle: { fontSize: 24, fontFamily: FONTS.bold, color: '#92400E', textAlign: 'center', marginBottom: 25 },

  modalItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 15, marginBottom: 10, backgroundColor: '#F8FAFC', borderRadius: 20, borderWidth: 1, borderColor: '#E2E8F0' }, // Borda Fina Neutra
  modalIconBox: {
  ...
  closeModalButton: { marginTop: 15, width: '100%', height: 60, backgroundColor: '#F1F5F9', borderRadius: 20, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#E2E8F0' }, // Borda Fina Neutra

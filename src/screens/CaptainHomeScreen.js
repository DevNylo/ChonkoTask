...
export default function CaptainHomeScreen() {
  ...
  const renderHeader = () => (
    <View style={styles.headerContainer}>
        ...
        {/* BOTÃO QUE LEVA PARA A TELA COMPLETA DE GESTÃO */}
        <TouchableOpacity 
  ...
  const renderDashboardCard = ({ item }) => (
    <TouchableOpacity style={styles.dashCardWrapper} activeOpacity={0.9} onPress={() => handleCardPress(item)}>
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.fab} activeOpacity={0.8} onPress={() => navigation.navigate('MissionManager', { familyId: profile.family_id })}>
        <View style={styles.fabShadow} />
        <View style={styles.fabFront}><MaterialCommunityIcons name="plus" size={40} color={COLORS.white} /></View>
      </TouchableOpacity>
    </View>
  );
}

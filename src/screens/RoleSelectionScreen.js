...
const COLORS = {
  ...
  error: '#EF4444',
  shadow: '#166534', // Sombra verde escura      
  gold: '#F59E0B',       
  recruit: '#064E3B'     
};
...
export default function RoleSelectionScreen() {
  ...
  const verifyPin = () => {
    if (inputPin === selectedProfile.pin) {
      ...
      Alert.alert("Acesso Negado", "PIN incorreto. Tente novamente.");
      setInputPin('');
    }
  };
  ...
  if (loading) {
    return (
      <View style={[styles.center, { backgroundColor: COLORS.secondary }]}>
        ...
        <Text style={{color: COLORS.white, marginTop: 10, fontWeight: 'bold'}}>Carregando Tropa...</Text>
      </View>
    );
  }
...
const styles = StyleSheet.create({
  ...
  // Ajuste: paddingTop maior para dar espaço para a status bar
  overlay: { flex: 1, backgroundColor: 'rgba(255,255,255,0.90)', paddingTop: 50 }, 
  center: { flex: 1, justifyContent: 'center', alignItems: 'center' },

  // --- TOP BAR (LOGOUT) ---
  // Fica isolado no topo, alinhado à direita
  topBar: {
    width: '100%',
    alignItems: 'flex-end',
  ...
  cardName: { fontSize: 18, fontFamily: 'RobotoCondensed_700Bold', textAlign: 'center', marginBottom: 8 },
  
  roleBadge: { paddingHorizontal: 12, paddingVertical: 5, borderRadius: 12 },
  roleText: { fontSize: 12, fontFamily: 'RobotoCondensed_700Bold', color: COLORS.white, textTransform: 'uppercase', letterSpacing: 1 },
  
  lockBadge: { position: 'absolute', top: 12, right: 12, backgroundColor: COLORS.error, width: 26, height: 26, borderRadius: 13, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: COLORS.white },

  // --- MODAL ---
  modalOverlay: { flex: 1, backgroundColor: '#043125cc', justifyContent: 'center', alignItems: 'center', padding: 20 },
  modalContent: { width: '100%', backgroundColor: COLORS.white, borderRadius: 24, padding: 24, borderWidth: 3, borderColor: COLORS.primary, alignItems: 'center' },
  modalIcon: { width: 60, height: 60, backgroundColor: COLORS.inputBg, borderRadius: 30, justifyContent: 'center', alignItems: 'center', marginBottom: 15, borderWidth: 2, borderColor: COLORS.primary },
  modalTitle: { fontSize: 22, fontFamily: 'RobotoCondensed_700Bold', color: COLORS.primary, marginBottom: 5 },
  modalSubtitle: { fontSize: 14, color: '#666', marginBottom: 20, fontFamily: 'RobotoCondensed_400Regular' },
  
  pinInputWrapper: { width: '100%', marginBottom: 20 },
  pinInput: { width: '100%', height: 50, borderWidth: 2, borderColor: COLORS.primary, borderRadius: 12, backgroundColor: COLORS.inputBg, textAlign: 'center', fontSize: 24, fontFamily: 'RobotoCondensed_700Bold', color: COLORS.primary, letterSpacing: 5 },
  ...
  modalBtnTextCancel: { fontFamily: 'RobotoCondensed_700Bold', color: COLORS.primary },
  modalBtnTextConfirm: { fontFamily: 'RobotoCondensed_700Bold', color: COLORS.white },

  // --- EMPTY STATE ---
  emptyContainer: { alignItems: 'center', marginTop: 50 },
  emptyCard: { backgroundColor: COLORS.white, padding: 30, borderRadius: 20, borderWidth: 3, borderColor: COLORS.primary, alignItems: 'center', width: '100%' },
  emptyTitle: { fontSize: 20, fontFamily: 'RobotoCondensed_700Bold', color: COLORS.primary, marginTop: 10 },
  ...
  retryText: { color: COLORS.white, fontFamily: 'RobotoCondensed_700Bold', fontSize: 12 }
});